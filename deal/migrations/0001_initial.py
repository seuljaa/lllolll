    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('server', models.CharField(choices=[('베라', '베라'), ('스카니아', '스카니아'), ('루나', '루나'), ('제니스', '제니스'), ('크로아', '크로아'), ('유니온', '유니온'), ('엘리시움', '엘리시움'), ('이노시스', '이노시스'), ('레드', '레드'), ('오로라', '오로라'), ('아케인', '아케인'), ('노바', '노바')], max_length=10, verbose_name='서버')),
